...
void procesar_paquete_udp(String datosPaquete) {
  ...
  switch (codigo) {
    ...
    case 1000:
      //Realizar el barrido.
      /* Lo que esta en este bloque ignorar, era para pruebas viejas. Eliminar cuando este el barrido
...
void conectar_cliente(){
  ...
  String mensaje = "AP IP:" + ipServidorUDP.toString();  // Construir el mensaje como String
